...
<body class="min-h-screen flex items-center justify-center px-4 py-12 relative">
    ...
    <div class="login-card relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="font-display text-2xl md:text-3xl font-bold text-white mt-2">Create Account</h1>
            <p class="text-sm text-frost mt-2">Register to access the admin dashboard</p>
        </div>
        ...
        <div class="rounded-2xl border border-electric/20 overflow-hidden"
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    {{-- Name --}}
                    <div>
                        <label for="name" class="block text-xs font-semibold uppercase tracking-widest text-smoke mb-2">
                            Full Name
                        </label>
                        <div class="relative">
            ...
            <div class="px-8 py-4 border-t border-electric/10 flex items-center justify-center gap-2"
                ...
                <span class="text-xs text-smoke">Already have an account?</span>
                <a href="{{ route('login') }}"
